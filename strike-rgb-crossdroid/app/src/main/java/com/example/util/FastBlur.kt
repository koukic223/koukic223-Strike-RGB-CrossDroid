...
/**
 * High-performance, memory-efficient StackBlur algorithm for Android.
 * Runs in O(N) time and produces a smooth Gaussian-like blur.
 * Optimized for resource-constrained devices like MT6735M / ARM32 Android Go.
 */
object FastBlur {
